...
const contactLinks = [
  {
    element: (
      <a
        ...
        key="linkedin"
        className="rounded-sm border-white border-2 p-1 mx-1 hover:border-indigo-500 hover:bg-indigo-500 duration-300"
...
const ContactSection = (): JSX.Element => (
  <section className="w-full flex flex-col justify-center items-center">
    ...
    <div className="flex mt-2">{contactLinks.map((link) => link.element)}</div>
  </section>
);
